# Demonstration of how parametric surfaces are
# generated in manim-master, made with manim-shaders

# TODO : Figure out why this doesn't work
# when the unit_size of axes is altered
...
class DemonstrateParametricSurfaces(ThreeDScene):
    ...
    def show_xy_space_rects(self, anim_style=FadeIn, **kwargs):
        self.play(
            AnimationGroup(
                *map(anim_style, self.surface_rects),
                **kwargs
            )
        )
    ...
    def show_what_apply_function_does(self, added_anims=[], **kwargs):
        ...
        self.play(
            AnimationGroup(
                ApplyFunction(
                    func, self.surface_rects,
                    lag_ratio=kwargs["lag_ratio"]
                    ),
                *added_anims,
...
class SphereDemo(DemonstrateParametricSurfaces):
    CONFIG = {
        "x_range": (0, PI), "y_range": (0, TAU), "resolution": (20, 40),
    }
    ...
    def construct(self):
        ...
        gratitude = TextMobject(
            "Thank you ", "Grant Sanderson", "!").scale(1.25)
...
class SurfaceDemo(DemonstrateParametricSurfaces):
    CONFIG = {
        "x_range": (-4, 4), "y_range": (-4, 4), "resolution": (40, 40),
    }
